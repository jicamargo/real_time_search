class SearchController < ApplicationController
  ...
  def get_queries
    ...
    @user ="Guest"  #created for future use

    existing_story = SearchStory.find_by(ip_address: @ip_address, user: @user, query: @search_query)
    ...
    delete_incomplete_querie(@ip_address, @user, @search_query)
  ...
  def delete_incomplete_querie(ip_address, user, search_query)
    queries = SearchStory
      .where(ip_address: ip_address, user: user)
